...
var debugger = createObjectIn(chrome, { defineAs: "debugger" });
exportFunction(chromeAPIBridge.bind(null,{"namespace":"debugger","method":"attach","success":2},debugger,{ defineAs:"attach"});
exportFunction(chromeAPIBridge.bind(null,{"namespace":"debugger","method":"detach","success":1},debugger,{ defineAs:"detach"});
exportFunction(chromeAPIBridge.bind(null,{"namespace":"debugger","method":"sendCommand","success":3},debugger,{ defineAs:"sendCommand"});
exportFunction(chromeAPIBridge.bind(null,{"namespace":"debugger","method":"getTargets","success":0},debugger,{ defineAs:"getTargets"});
